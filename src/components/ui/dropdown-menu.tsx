...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        "relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm text-white/80 outline-hidden select-none hover:bg-white/[0.05] hover:text-white/95 transition-all duration-200 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm text-white/80 outline-hidden transition-all duration-200 hover:bg-white/[0.05] hover:text-white/95 data-[state=open]:bg-white/[0.05] data-[state=open]:text-white/95 data-[inset]:pl-8",
        className
      )}
      {...props}
    >
